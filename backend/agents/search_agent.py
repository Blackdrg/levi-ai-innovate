...
class SearchAgent(SovereignAgent[SearchInput, AgentResult]):
    """
    Sovereign Search Navigator.
    Executes hybrid search (Local + Web) and synthesizes factual insights.
    """
    ...
    async def _run(self, input_data: SearchInput, lang: str = "en", **kwargs) -> Dict[str, Any]:
        """
        Discovery Protocol v8:
        1. Hybrid Search Execution.
        2. Council-based Insight Synthesis.
        """
        query = input_data.input
        self.logger.info(f"Navigating the Pulse: '{query[:40]}'")
        
        # Engagement of the Search Engine bridge
