...
The system implements **Recursive Self-Improvement** via:
- **Dreaming Phase:** Periodic distillation of episodic memory into permanent traits.
- **Survival Score:** Importance-based mathematical decay (Importance vs Time).
