...
export default function Console() {
  ...
  return (
    <div className="flex-1 p-4 md:p-8 overflow-y-auto custom-scrollbar bg-[#020202]">
      <div className="max-w-5xl mx-auto space-y-6 md:space-y-10">
        ...
        <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-0">
          <div className="space-y-1">
             ...
             <h1 className="text-4xl md:text-5xl font-heading font-black tracking-tighter text-white uppercase italic leading-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 md:gap-10">
          ...
          <div className="lg:col-span-3 space-y-6 md:space-y-8 order-2 lg:order-1">
            <div className="relative group">
               <div className="absolute -inset-[2px] bg-gradient-to-r from-emerald-500/20 via-purple-500/20 to-blue-500/20 rounded-[1.5rem] md:rounded-[2.5rem] blur-xl opacity-20 group-focus-within:opacity-100 transition-all duration-1000" />
               <div className="relative bg-[#050505] rounded-[1.5rem] md:rounded-[2.5rem] border border-white/5 p-6 md:p-8 space-y-6 shadow-2xl">
                  ...
                  <textarea 
                    ...
                    className="w-full h-40 md:h-56 bg-transparent border-none outline-none text-white/95 placeholder:text-white/10 resize-none font-sans text-lg md:text-xl leading-relaxed selection:bg-emerald-500/30"
                    disabled={isLaunching}
                  />
                  
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-6 border-t border-white/5 gap-6 sm:gap-0">
                     <div className="flex items-center gap-4">
                        <TierBadge tier={tier} />
                        <div className="flex flex-col">
                           <span className="text-[9px] text-white/40 font-bold uppercase tracking-widest">Predictive Logic</span>
                           <span className="text-[8px] text-white/20 italic">Tier {tier} detected</span>
                        </div>
                     </div>
                     <button 
                       onClick={handleLaunch}
                       disabled={isLaunching || !query.trim()}
                       className="w-full sm:w-auto group relative px-8 py-3.5 bg-white text-black rounded-2xl flex items-center justify-center gap-3 hover:scale-105 active:scale-95 transition-all disabled:opacity-30 disabled:scale-100 overflow-hidden"
                     >
            ...
            {!missionId && !isLaunching && (
              <div className="p-12 md:p-20 border border-dashed border-white/5 rounded-[1.5rem] md:rounded-[2.5rem] flex flex-col items-center justify-center opacity-20 hover:opacity-30 transition-opacity group">
                 <div className="relative mb-6">
                    <Sparkles className="text-white relative z-10" size={32} md:size={48} strokeWidth={1} />
               ...
               {missionId ? (
                 ...
                 >
                    ...
                    <div className="p-6 glass rounded-2xl border border-white/5 shadow-xl">
                       ...
                       <div className="space-y-3 max-h-40 md:max-h-64 overflow-y-auto text-[10px] font-mono custom-scrollbar pr-2">
                 ...
                 <div className="h-40 md:h-auto p-8 md:p-12 glass rounded-[1.5rem] md:rounded-[2rem] border border-white/5 flex flex-col items-center justify-center gap-6 opacity-30 group relative overflow-hidden">
                    ...
                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl md:rounded-3xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:border-emerald-500/20 transition-colors">
                       <Zap size={20} md:size={24} className="text-white group-hover:text-emerald-400 transition-colors" />
                    </div>
                    <div className="text-center space-y-3">
                       <h4 className="text-[10px] font-black text-white uppercase tracking-[0.2em]">Neural Pulse</h4>
                       <p className="text-[9px] md:text-[10px] text-white/40 leading-relaxed max-w-[180px] mx-auto hidden md:block">
                          Waiting for cognitive emission. Launch a mission witness the absolute autonomy.
                       </p>
                    </div>
                 </div>
               )}
