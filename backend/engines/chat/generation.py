...
async def generate_chat_response(
    ...
    """
    Standardized async entry point for chat-based completion.
    Used by specialized agents and the Fusion Engine for high-fidelity synthesis.
    """
    ...
    return response or "LEVI encountered a momentary silence in the fusion chamber."
